...
| Sites | No complete page/version builder, domain binding, hosting, or publication lifecycle | Omitted | Build as its own complete vertical slice rather than extending Forms or Surveys with placeholders |
