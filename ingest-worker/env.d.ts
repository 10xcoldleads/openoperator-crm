/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=ingest-worker/wrangler.jsonc ingest-worker/env.d.ts` (hash: c78911f9695ea799ddb43a8ac9060678)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 
interface __BaseEnv_Env {
	INGEST_RATE_LIMITER: RateLimit;
	CRM_ORIGIN: "https://crm.example.com";
	INGEST_RATE_GATE: DurableObjectNamespace<import("./index").IngestRateGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "IngestRateGate";
	}
